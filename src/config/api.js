...
export const GoodsCategory = 'goods/category' //获得分类数据
...
export const GoodsFilter = '/goods/filter'
...
export const UserGetUserInfo = 'user/getUserInfo' //微信查询订单状态
export const UserUpdateUserInfo = 'user/updateUserInfo' //微信查询订单状态
